...
def test_similar_neigh_distrib(
    ...
    of the new data is significantly different than that of the reference
    dataset
    """
...
def test_row_count(data):
    """
    Test the number of rows in the data
    """
...
def test_price_range(data, min_price, max_price):
    """
    Test if the price feature has values within the min_price
    and max_price range
    """
